...
#-DCMAKE_TOOLCHAIN_FILE=$POLLY_DIR/linux-mingw-w64.cmake -GNinja 
cmake -H$SRC_DIR -B$BUILD_DIR -DCMAKE_TOOLCHAIN_FILE=$POLLY_DIR/linux-mingw-w64.cmake -DCMAKE_INSTALL_PREFIX=$HOME/opt -DCMAKE_VERBOSE_MAKEFILE=true -DCMAKE_BUILD_TYPE=Debug -DPOCO_ENABLE_CRYPTO=OFF -DPOCO_ENABLE_NETSSL_WIN=OFF -DPOCO_ENABLE_PDF=OFF -DPOCO_ENABLE_SQL_SQLITE=ON -DPOCO_ENABLE_TESTS=ON -DPOCO_ENABLE_SAMPLES=ON && \
...
ls -R $BUILD_DIR/lib && ls -R $HOME/opt
